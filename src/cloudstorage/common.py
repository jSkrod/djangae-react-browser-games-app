...
from google.appengine.api import modules as moduleAPI
...
def local_api_url():
  ...
  return 'http://%s%s' % (moduleAPI.get_hostname(module=moduleAPI.get_current_module_name()), LOCAL_GCS_ENDPOINT)
